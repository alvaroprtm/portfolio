  ...
  return (
    <div id='contact' className='bg-abyss min-h-screen w-full relative flex flex-col items-center justify-center py-16'>
      ...
      <div className='flex gap-8 mt-8'>
        ...
        >
          <svg width="24" height="24" fill="currentColor" className="inline" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75.784 1.75 1.75-.784 1.75-1.75 1.75zm13.5 11.268h-3v-5.604c0-1.337-.026-3.063-1.868-3.063-1.868 0-2.154 1.459-2.154 2.967v5.7h-3v-10h2.881v1.367h.041c.401-.761 1.379-1.563 2.838-1.563 3.036 0 3.598 2 3.598 4.59v5.606z"/></svg>
          LinkedIn
        </a>
        <a
          href='mailto:alvaro.maharto@outlook.com'
